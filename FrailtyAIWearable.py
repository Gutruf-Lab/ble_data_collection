        ...
        try:
            ...
            for d in devices:
                ...
                if d.name:
                    ...
                    if d.name == target_device_name:
                        target_device_address = d.address
                        print('****')
                        print('Device found.')
                        print("Attempting connection to " + target_device_address + "...")
                        print('****')
            print('---------')
            ...
            if target_device_address is not None:
                async with BleakClient(target_device_address, disconnected_callback = disconnect_callback) as client:
                    ...
                    await client.start_notify('0000fe42-8e22-4541-9d4c-21edae82ed19', frailty_gait_notification_handler)
...
if __name__ == "__main__":
    ...
    try:
        asyncio.run(connect_to_device(target_device_name = target_name,
                                      target_device_address = target_address))
